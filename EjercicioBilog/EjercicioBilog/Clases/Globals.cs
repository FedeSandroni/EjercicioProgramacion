...
namespace Motor
{
    public class Globals
    {
        ...
        public static readonly string connectionString = "server=FEDESANDRONI\\SQLEXPRESS;database=GestionEmpleados;Trusted_Connection=true;TrustServerCertificate=true;";
