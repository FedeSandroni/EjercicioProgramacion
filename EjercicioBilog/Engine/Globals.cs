...
namespace Motor
{
    public class Globals
    {
        ...
        /// </summary>
        public static readonly string connectionString = "Data Source=IP;Database=NOMBRE DE LA BASE DE DATOS;User Id=USUARIO;Password=CONTRASEÑA";
        ...
        /// <param Name="query"></param>
        /// <returns></returns>
        public int CommandExecuteQueryScalar(string query)
        {
            int result = 0;
            try
            {
